...
def main():
    ...
    if st.button("Reset Starting Certificate Number to 939"):
        save_last_cert_number(939)
        st.success("Starting Certificate number reset to 939. Trimite mesaj daca merge")
