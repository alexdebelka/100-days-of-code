...
def main():
    ...
    if st.button("Reset Starting Certificate Number to 1351"):
        save_last_cert_number(1351)
        st.success("Starting Certificate number reset to 1351. Trimite mesaj daca merge")
