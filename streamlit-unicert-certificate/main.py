...
def main():
    ...
    if st.button("Reset Starting Certificate Number to 1116"):
        save_last_cert_number(1116)
        st.success("Starting Certificate number reset to 1116. Trimite mesaj daca merge")
