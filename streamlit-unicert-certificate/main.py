...
def main():
    ...
    if st.button("Reset Starting Certificate Number to 1002"):
        save_last_cert_number(1002)
        st.success("Starting Certificate number reset to 1002. Trimite mesaj daca merge")
