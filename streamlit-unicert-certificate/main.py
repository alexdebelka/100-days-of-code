...
def main():
    ...
    if st.button("Reset Starting Certificate Number to 1285"):
        save_last_cert_number(1285)
        st.success("Starting Certificate number reset to 1285. Trimite mesaj daca merge")
