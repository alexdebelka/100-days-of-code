...
def main():
    ...
    if st.button("Reset Starting Certificate Number to 1442"):
        save_last_cert_number(1442)
        st.success("Starting Certificate number reset to 1442. Trimite mesaj daca merge")
